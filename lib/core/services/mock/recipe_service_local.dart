...
class LocalRecipeServiceMock implements RecipeService {
  ...
  Recipe(id: "1", name: "Spaghetti Carbonara", ingredients: [
    ...
    Ingredient(id: "4", name: "Parmigiano Reggiano", quantity: 0.1, unit: Unit.kg)
  ]);

  static var recipe2 =
  Recipe(id: "2", name: "Chicken Alfredo", ingredients: [
  ...
  static var recipe3 =
  Recipe(id: "3", name: "Margherita Pizza", ingredients: [
  ...
  static var recipe4 =
  Recipe(id: "4", name: "Caesar Salad", ingredients: [
    Ingredient(id: "1", name: "Romaine Lettuce", quantity: 1, unit: Unit.pieces),
    Ingredient(id: "2", name: "Caesar Dressing", quantity: 0.1, unit: Unit.liters),
  ...
  static var recipe5 =
  Recipe(id: "5", name: "Beef Tacos", ingredients: [
